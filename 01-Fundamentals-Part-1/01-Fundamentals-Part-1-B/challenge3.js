...
const avgDolphines = (96+11+101)/3;
const avgKoalas = (109+19+106)/3;
console.log(avgDolphines,avgKoalas);
if (avgDolphines > avgKoalas && avgDolphines>=100){
    console.log("Dolphines won");
}else if (avgKoalas > avgDolphines && avgKoalas>=100){
    console.log("Koalas won");
}else if (avgDolphines>=100 && avgKoalas>=100 && avgDolphines===avgKoalas){
